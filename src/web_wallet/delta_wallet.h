...
namespace cryptonote
{
  ...
  /*                                                                      */
  /************************************************************************/
  class delta_wallet : public tools::i_wallet2_callback
  {
  public:
  ...
  private:
    ...
    {
    public:
      refresh_progress_reporter_t(cryptonote::delta_wallet& delta_wallet)
        : m_delta_wallet(delta_wallet)
    ...
    private:
      ...
      {
        std::string err;
        uint64_t blockchain_height = m_delta_wallet.get_daemon_blockchain_height(err);
        if (err.empty())
        {
    ...
    private:
      cryptonote::delta_wallet& m_delta_wallet;
